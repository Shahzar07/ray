...
/**
 * Any URL that does not resolve — a stale bookmark or a mistyped path — lands
 * here instead of the bare framework 404.
 */
    ...
    <main className="grid min-h-[75vh] place-items-center p-6">
      <div className="max-w-md rounded-2xl border border-line bg-surface p-8 shadow-lg">
        ...
        <p className="mt-3 text-sm text-muted">
          The link may be out of date. Everything else in your workspace is
          unaffected.
        </p>
        <Link
          href="/today"
