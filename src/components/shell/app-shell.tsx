  ...
  return (
    <div className="min-h-dvh">
      ...
      <div className="lg:pl-[248px]">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-line bg-surface px-4 py-3 sm:px-6"><span className="hidden text-[11px] font-semibold uppercase tracking-[.16em] text-subtle sm:block">Workspace / {ctx.team.name}</span><ClockControl /></div>
